...
class PyControlDropDown(PyBaseControl):
    ...
    def OnDropDownOptionSelected(
        self, onSelectionChanged: "Any"
    ) -> "PyControlDropDown":
        """
...
class PyGumps:
    ...
    def CreateGumpCheckbox(
        self, text: "str" = "", hue: "int" = 0, isChecked: "bool" = False
    ) -> "PyCheckbox":
        """
    ...
    def CreateGumpColorBox(
        self, opacity: "float" = 0.7, color: "str" = "#000000"
    ) -> "PyAlphaBlendControl":
        """
    ...
    def CreateGumpItemPic(
        self, graphic: "int", width: "int", height: "int"
    ) -> "PyResizableStaticPic":
        """
    ...
    def CreateGumpButton(
        ...
        while True:
            ...
            API.SysMsg(
                "Button clicked since last check?: " + str(button.HasBeenClicked())
            )
            API.Pause(0.2)
        ```
    ...
    def CreateGumpTTFLabel(
        self,
        text: "str",
        size: "float",
        color: "str" = "#FFFFFF",
        font: "str" = TrueTypeLoader.EMBEDDED_FONT,
        aligned: "str" = "let",
        maxWidth: "int" = 0,
    ...
    def CreateGumpSimpleProgressBar(
        self,
        width: "int",
        height: "int",
        backgroundColor: "str" = "#616161",
        foregroundColor: "str" = "#212121",
        value: "int" = 100,
        max: "int" = 100,
    ) -> "PySimpleProgressBar":
        """
    ...
    def CreateGumpPic(
        self, graphic: "int", x: "int" = 0, y: "int" = 0, hue: "int" = 0
    ) -> "PyGumpPic":
        """
    ...
    def CreateTiledGumpPic(
        self, graphic: "int", width: "int", height: "int", hue: "int" = 0
    ) -> "Any":
        """
    ...
    def CreateDropDown(
        self, width: "int", items: "list[str]", selectedIndex: "int" = 0
    ) -> "PyControlDropDown":
        """
    ...
    def AddControlOnClick(
        self, control: "Any", onClick: "Any", leftOnly: "bool" = True
    ) -> "Any":
        """
    ...
    def AddControlOnDisposed(
        self, control: "PyBaseControl", onDispose: "Any"
    ) -> "PyBaseControl":
        """
...
class PyNiceButton(PyBaseControl):
    ...
    def SetBackgroundColor(
        self, r: "int | None", g: "int | None", b: "int | None", a: "int | None" = 255
    ) -> None:
        """
...
def MenuResponseCurrent(
    index: "int", itemGraphic: "int" = 0, itemHue: "int" = 0
) -> "bool":
    """
...
def PartyMsg(message: "str") -> None:
    ...
    ```py
    API.PartyMsg(
        "The raid begins in 30 second! Wait... we don't have raids, wrong game.."
    )
    ```
...
def GuildMsg(message: "str") -> None:
    ...
    ```py
    API.GuildMsg(
        "Hey guildies, just restocked my vendor, fresh valorite suits available!"
    )
    ```
...
def UseType(
    graphic: "int", hue: "int" = 1337, container: "int" = 1337, skipQueue: "bool" = True
) -> None:
    """
...
def PathfindEntity(
    entity: "int", distance: "int" = 1, wait: "bool" = False, timeout: "int" = 10
) -> "bool":
    """
...
def PreTarget(serial: "int", targetType: "str" = "neutral") -> None:
    ...
    API.UseObject(
        bandage_item
    )  # This will automatically target self when targeting request comes
...
def ConfigNextGump(
    ...
    autoRespond: "bool | None" = None,
    autoRespondButton: "int | None" = None,
) -> None:
    """
...
def NearestMobiles(
    notoriety: "list[Notoriety]", maxDistance: "int" = 10
) -> "list[PyMobile]":
    """
...
def GetAllMobiles(
    ...
    enemies = API.GetAllMobiles(
        distance=15, notoriety=[API.Notoriety.Murderer, API.Notoriety.Criminal]
    )
    ```
...
def CreateGump(
    acceptMouseInput: "bool" = True, canMove: "bool" = True, keepOpen: "bool" = False
) -> "PyBaseGump":
    """
...
def CreateGumpCheckbox(
    text: "str" = "", hue: "int" = 0, isChecked: "bool" = False
) -> "PyCheckbox":
    """
...
def CreateGumpColorBox(
    opacity: "float" = 0.7, color: "str" = "#000000"
) -> "PyAlphaBlendControl":
    """
...
def CreateGumpItemPic(
    graphic: "int", width: "int", height: "int"
) -> "PyResizableStaticPic":
    """
...
def CreateGumpTextBox(
    text: "str" = "", width: "int" = 200, height: "int" = 30, multiline: "bool" = False
) -> "PyTTFTextInputField":
    """
...
def CreateGumpPic(
    graphic: "int", x: "int" = 0, y: "int" = 0, hue: "int" = 0
) -> "PyGumpPic":
    """
...
def CreateDropDown(
    width: "int", items: "list[str]", selectedIndex: "int" = 0
) -> "PyControlDropDown":
    """
